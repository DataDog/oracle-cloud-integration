...
VARIABLES_JSON=$(jq -n \
  ...
  --arg image_realm "$IMAGE_REALM" \
  '{tenancy_ocid: $tenancy_ocid, region: $region, compartment_ocid: $compartment_ocid, datadog_site: $datadog_site, api_key_secret_id: $api_key_secret_id, home_region: $home_region, region_key: $region_key, subnet_ocid: $subnet_ocid, defined_tags: $defined_tags, enable_regional_vaults: $enable_regional_vaults, custom_datadog_site: $custom_datadog_site, image_namespace: $image_namespace, image_realm: $image_realm}')
